...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Gayathri|Manjari&display=swap" rel="stylesheet">
...
<head>
 <title>Dakshraj Ng - Spirulina Producing Company</title>
 <meta charset="utf-8">
 ...
 <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url(); ?>/Twin-Screw-And-Barrel">Twin Screw & Barrel </a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url(); ?>/Die-Head-And-Dies">Die Head And Dies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url(); ?>/consultancy">Consultancy </a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class = "fa fa-mobile"></i> (+91) 6380384072</a>
                    </li>
                </ul>
				...
				<div class="col-lg-10 col-md-10">
					<div class="clv_right_header">
								...
								<div class="col-md-4">
									<div class="address_block">
										...
										<div class="header_location">
											<h5>our location</h5>
											<p>Survey No 394/1, Suralwadi, Gangakhed, Parbhani(Dist)
</p>
										</div>
									</div>
								</div>
						...
						<div class="clv_menu">
							...
							<a href="javascript:;" class="appointment_btn">Get a Quote</a>
						</div>
					</div>
				</div>
			</div>
